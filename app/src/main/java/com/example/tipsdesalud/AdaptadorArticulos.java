...
public class AdaptadorArticulos extends RecyclerView.Adapter<AdaptadorArticulos.ViewHolder> {
    ...
    public AdaptadorArticulos(List<ModeloArticulos.Articulo> items, OnItemClickListener escuchaClicksExterna){
        valores = items;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_lista_articulos, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position){
        ...
        Glide.with(holder.itemView.getContext()).load(holder.item.urlMiniatura).thumbnail(0.1f).into(holder.viewMiniatura);
    }
